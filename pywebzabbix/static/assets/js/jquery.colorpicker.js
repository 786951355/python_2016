...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<td width="3"><td><input type="text" id="HexColor" size="4" style="border:inset 1px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a>|<a href="javascript:void(0);" id="_creset">清除</a></td></tr></table></td></table>'
